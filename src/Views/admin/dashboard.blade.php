                                    ...
                                    <table class="table lms_table_active2 p-0">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="customer d-flex align-items-center">
                                                        <div class="thumb_34 mr_15 mt-0"><img class="img-fluid radius_50" src="{{asset('assets/admin/img/customers/2.png')}}" alt></div>
                                                        <span class="f_s_14 f_w_400 color_text_1">Customer</span>
                                                    </div>
                                                </td>
                                                <td class="f_s_14 f_w_400 color_text_2">Sunglass</td>
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="customer d-flex align-items-center">
                                                        <div class="thumb_34 mr_15 mt-0"><img class="img-fluid radius_50" src="{{asset('assets/admin/img/customers/3.png')}}" alt></div>
                                                        <span class="f_s_14 f_w_400 color_text_1">Customer</span>
                                                    </div>
                                                </td>
                                                <td class="f_s_14 f_w_400 color_text_2">Sunglass</td>
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="customer d-flex align-items-center">
                                                        <div class="thumb_34 mr_15 mt-0"><img class="img-fluid radius_50" src="{{asset('assets/admin/img/customers/4.png')}}" alt></div>
                                                        <span class="f_s_14 f_w_400 color_text_1">Customer</span>
                                                    </div>
                                                </td>
                                                <td class="f_s_14 f_w_400 color_text_2">Sunglass</td>
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="customer d-flex align-items-center">
                                                        <div class="thumb_34 mr_15 mt-0"><img class="img-fluid radius_50" src="{{asset('assets/admin/img/customers/5.png')}}" alt></div>
                                                        <span class="f_s_14 f_w_400 color_text_1">Customer</span>
                                                    </div>
                                                </td>
                                                <td class="f_s_14 f_w_400 color_text_2">Sunglass</td>
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="customer d-flex align-items-center">
                                                        <div class="thumb_34 mr_15 mt-0"><img class="img-fluid radius_50" src="{{asset('assets/admin/img/customers/6.png')}}" alt></div>
                                                        <span class="f_s_14 f_w_400 color_text_1">Customer</span>
                                                    </div>
                                                </td>
                                                <td class="f_s_14 f_w_400 color_text_2">Sunglass</td>
                                    ...
                                    <table class="table lms_table_active2 p-0">
                                        ...
                                        <tbody>
                                            <tr>
                                                <td>
                                                    <div class="customer d-flex align-items-center">
                                                        <div class="thumb_34 mr_15 mt-0"><img class="img-fluid radius_50" src="{{asset('assets/admin/img/customers/pro_1.png')}}" alt></div>
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="customer d-flex align-items-center">
                                                        <div class="thumb_34 mr_15 mt-0"><img class="img-fluid radius_50" src="{{asset('assets/admin/img/customers/pro_2.png')}}" alt></div>
                                                        <span class="f_s_14 f_w_400 color_text_1">Product 1</span>
                                                    </div>
                                                </td>
                                                <td class="f_s_14 f_w_400 color_text_2">$564</td>
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="customer d-flex align-items-center">
                                                        <div class="thumb_34 mr_15 mt-0"><img class="img-fluid radius_50" src="{{asset('assets/admin/img/customers/pro_3.png')}}" alt></div>
                                                        <span class="f_s_14 f_w_400 color_text_1">Product 1</span>
                                                    </div>
                                                </td>
                                                <td class="f_s_14 f_w_400 color_text_2">$564</td>
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="customer d-flex align-items-center">
                                                        <div class="thumb_34 mr_15 mt-0"><img class="img-fluid radius_50" src="{{asset('assets/admin/img/customers/pro_4.png')}}" alt></div>
                                                        <span class="f_s_14 f_w_400 color_text_1">Product 1</span>
                                                    </div>
                                                </td>
                                                <td class="f_s_14 f_w_400 color_text_2">$564</td>
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="customer d-flex align-items-center">
                                                        <div class="thumb_34 mr_15 mt-0"><img class="img-fluid radius_50" src="{{asset('assets/admin/img/customers/pro_5.png')}}" alt></div>
                                                        <span class="f_s_14 f_w_400 color_text_1">Product 1</span>
                                                    </div>
                                                </td>
                                                <td class="f_s_14 f_w_400 color_text_2">$564</td>
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="customer d-flex align-items-center">
                                                        <div class="thumb_34 mr_15 mt-0"><img class="img-fluid radius_50" src="{{asset('assets/admin/img/customers/pro_6.png')}}" alt></div>
                                                        <span class="f_s_14 f_w_400 color_text_1">Product 1</span>
                                                    </div>
                                                </td>
                                                <td class="f_s_14 f_w_400 color_text_2">$564</td>
                                    ...
                                    <table class="table lms_table_active2 p-0">
                                        ...
                                        <tbody>
                                            <tr>
                                                {{-- <td>
                                                    <div class="customer d-flex align-items-center">
                                                        <div class="thumb_62 mr_15 mt-0"><img class="img-fluid radius_50" src="{{asset('assets/admin/img/customers/pro_big.png')}}" alt></div>
                                                        <span class="f_s_20 f_w_400 color_text_3">Unique Watch</span>
                                                    </div>
                                                </td> --}}
                                                <td class="f_s_14 f_w_400 color_text_4">Categories</td>
                                                <td class="f_s_14 f_w_400 color_text_3">{{$cate}}</td>
                                            ...
                                            <tr>
                                                ...
                                                <td class="f_s_14 f_w_400 color_text_4">Product</td>
                                                <td class="f_s_14 f_w_400 color_text_3">{{$sp}}</td>
                                                <td class="f_s_14 f_w_400 text-end"><a href="#" class="badge_btn_1">354 sold</a></td>
                                            </tr>
                                            <tr>
                                                {{-- <td>
                                                    <div class="customer d-flex align-items-center">
                                                        <div class="thumb_62 mr_15 mt-0"><img class="img-fluid radius_50" src="{{asset('assets/admin/img/customers/pro_big_1.png')}}" alt></div>
                                                        <span class="f_s_20 f_w_400 color_text_3">Wireless Headphone</span>
                                                    </div>
                                                </td> --}}
                                                <td class="f_s_14 f_w_400 color_text_4">Users</td>
                                                <td class="f_s_14 f_w_400 color_text_3">{{$user}}</td>
                                                <td class="f_s_14 f_w_400 text-end"><a href="#" class="badge_btn_1">354 sold</a></td>
                                            </tr>
